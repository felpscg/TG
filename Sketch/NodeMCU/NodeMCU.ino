...
const char http_site[] = "http://192.168.2.11";
const int http_port = 80;

WiFiClient client;
IPAddress server(192,168,2,11); //ENDEREÇO DO SERVIDOR - FORMATO XXX,XXX,XXX,XXX
...
void loop() {
	...
	if ( !client.connect(server, http_port) ) {
		...
		client.println("GET http://192.168.2.11:80/class/DAO/vagaDAO.php" + param + " HTTP/1.1"); // EX: http://192.168.1.114:8080/ambiente/webservice.php
		client.println("Host: ");
