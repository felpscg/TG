...
//        . " <p><span>Local:</span></p>\n"
        ...
        . " <p><input type = 'text' name = 'nome' value='' pattern='[a-z A-Z]+' required='required'/></p>\n"
        . " <p><input type = 'text' name = 'cpf' oninput = 'TestaCPF();' pattern='[0-9]+'/></p>\n"
        . " <p><input type = 'text' name = 'rg'  pattern='[0-9]+'/></p>\n"
        . " <p><input type = 'date' name = 'datanascimento'/></p>\n"
//        . " <p><input type = 'text' name = 'ddd'/></p>\n"
        . " <p><input type = 'text' name = 'telefone'  pattern='[0-9]+'/></p>\n"
...
//        . "</select></p>"
        ...
        . " </div>\n"
        . " <div class = 'item-campo'>\n"
        . " <p><input type = 'text' name = 'placa' id = 'placa' onblur = '' pattern='[a-zA-Z0-9]+'/></p>\n"
